...
cred = credentials.Certificate(os.path.expanduser('~/Downloads/FoodApp-f159b8af6d71.json'))
    ...
    if request.method == 'POST':
        ...
        for items in recommendlist:
            ...
            for whtever in ordered_dict:
                ...
                FoodNameList.append(snapshot1.get('shrt_Desc'))
                print FoodName
        return jsonify(FoodNameList)  # Returning only the last item of the list. Need all to be returned
